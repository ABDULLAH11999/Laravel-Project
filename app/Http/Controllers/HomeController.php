...
return redirect()->back();
  ...
  public function stripe($totalprice){
   ...
   public function add_comment(Request $request){
    ...
    $comment->save();
    return redirect()->back()->with('message','Your comment added successfully!');
   }
   else{ 
      return redirect('login');
     }
 ...
 public function add_reply(Request $request){
   if (Auth::id())
   {
      ...
      $reply->save();
      return redirect()->back()->with('message','Your reply added successfully!');
   }
   ...
   public function product_search(Request $request){
      ...
      $product=products::where('title','LIKE', "%$search_text%")->orwhere('category','LIKE', "$search_text")->paginate(9);
      return view('home.userpage', compact('product','comment','reply'));
   }
